<template>
  <div>
    <div class="container px-8 pt-40 mx-auto lg:px-48">
      <div class="pb-16">
        <div class="mb-4 text-2xl font-bold" v-html="$t('home.title')" />
        <p v-html="$t('home.content')" />
      </div>
      <div class="pb-16">
      ...
      <div class="items-end pt-8 pb-6 mx-auto border-b-2 border-gray-300 md:flex md:justify-between">
        <div class="mb-4 text-2xl md:mb-0">Change Plan</div>
        <div>
          <a href="#" class="no-underline hover:underline">Cancel your plan</a>
        </div>
      </div>
      <div class="py-8 mx-auto md:flex md:justify-between md:flex-wrap">
        <selectable-plan
          plan-name="Hobby"
          plan-gigs="1"
          plan-dollars="5"
    ...
    <div class="container pb-12 mx-auto mt-10">
