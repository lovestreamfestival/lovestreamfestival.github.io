<template>
  <div class="relative">
    ...
    >
      <img src="/gfx/avatar.jpg" alt="avatar" class="w-8 h-8 rounded-full">
    ...
    <transition name="dropdown-fade">
      <ul v-on-clickaway="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute w-48 py-1 mt-2 overflow-hidden font-normal normal-case bg-white border rounded shadow xs:left-0 lg:right-0 lg:z-20">
        <li>
          <a
            href="#"
            ref="account"
