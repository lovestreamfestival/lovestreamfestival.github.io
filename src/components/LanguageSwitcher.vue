<template>
  <div class="relative">
    ...
    >
      <img :src="`/gfx/flag_${$i18n.locale}.svg`" alt="flag" class="w-8 h-8" />
      ...
      >
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="/gfx/flag_en.svg" alt="english flag" class="w-8 h-8" />
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="/gfx/flag_tr.svg" alt="Türkçe flag" class="w-8 h-8" />
